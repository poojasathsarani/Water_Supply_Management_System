    ...
    <div class="row">
        <div class="col-md-6">
            <a href="GenerateReport.php">
                <div class="content">
                    <img src="../images/generatereports.jpg" alt="fun1">
			        <h2>GENERATE REPORTS</h2>
                </div>
            </a>
        </div>
        <div class="col-md-6">
            <a href="GivePermission.php">
                <div class="content">
                    <img src="../images/givepermission.jpg" alt="fun2">
			       <h2>PERMISSIONS HANDLING</h2>
                </div>
            </a>
        </div>
        <div class="col-md-6">
            <a href="profilemanage.php">
                <div class="content">
                    <img src="../images/manageprofile.jpg" alt="fun3">
        ...
        <div class="col-md-6">
            <a href="requests.php">
                <div class="content">
                    <img src="../images/notificationhandling.jpg" alt="fun4">
			<h2>NOTIFICATIONS</h2>
                </div>
            </a>
        </div>
        <div class="col-md-6">
            <a href="maintenance.php">
                <div class="content">
                    <img src="../images/view.png" alt="fun5">
