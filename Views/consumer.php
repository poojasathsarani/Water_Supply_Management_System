    ...
    <div class="row">
        <div class="col-md-6">
            <a href="timeslots.php">
                <div class="content">
                    <img src="../images/billpayment1.png" alt="fun1">		
                    <h2>BILL PAYMENT</h2>
                </div>
            </a>
        </div>
        <div class="col-md-6">
            <a href="consumer_request.php">
                <div class="content">
                    <img src="../images/request.png" alt="fun2">
                    <h2>REQUEST </h2>
                </div>
            </a>
        </div>
        ...
        <div class="col-md-6">
            <a href="consumer_feedback.php">
                <div class="content">
                   <img src="../images/feedback.png" alt="fun4">
			<h2>FEEDBACK</h2>
                </div>
            </a>
        </div>
