...
<nav class="navbar navbar-expand-lg">
    <img class="logopic" src="../images/logo.jpeg">
...
<div class="container mt-4 Options">
    <div class="row">
        <div class="col-md-6">
            <a href="Updatetask.php">
                <div class="content">
                    <img src="../images/com.jpg" alt="fun1">
                    <h2>UPDATE COMPLETED TASKS</h2>
                </div>
            </a>
        </div>
        <div class="col-md-6">
            <a href="requestmaintenancetech.php">
                <div class="content">
                    <img src="../images/maintan.jpeg" alt="fun2">
                    <h2>REQUEST FOR MAINTANANCE</h2> 
                </div>
            </a>
        </div>
        <div class="col-md-6">
            <a href="profilemanage.php">
                <div class="content">
                    <img src="../images/profile.png" alt="fun3">
        ...
        <div class="col-md-6">
            <a href="viewdetails.php">
                <div class="content">
                    <img src="../images/view.png" alt="fun6">
                    <h2>VIEW DETAILS</h2>
                </div>
            </a>
        </div>
  ...
  <footer
          ...
          style="background: linear-gradient(108.9deg, rgb(18, 85, 150) 4.9%, rgb(100, 190, 150) 97%); margin-top:170px;padding:5px;"
          >
    ...
    <div
         ...
         style="position: absolute;width:99%;height:50px;"
         >
      © 2024 Copyright:
